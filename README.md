> [!TIP]
> For a newer and faster solution see: https://github.com/alekrutkowski/stata-rbridge and https://github.com/alekrutkowski/StataRLink_rbridge_wrapper
...
Importing data into R object 'StataData'...
------------------------------- R output start ---------------------------------
> str(StataData)
...
```
Exporting data from Stata...
Importing data into R object 'myOtherName'...
------------------------------- R output start ---------------------------------
> str(myOtherName)
'data.frame':   3 obs. of  2 variables:
 $ make: Factor w/ 3 levels "AMC Concord",..: 1 2 3
